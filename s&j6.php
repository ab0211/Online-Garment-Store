			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/s&j6.1.jpg">
								<div class="thumb-image"> <img src="images/s&j6.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/s&j6.2.jpg">
								<div class="thumb-image"> <img src="images/s&j6.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/s&j6.3.jpg">
							<div class="thumb-image"> <img src="images/s&j6.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Snuggles Girls Purple Sweater</h3>
						<span>Rs 649</span>
						<div class="clearfix"></div>

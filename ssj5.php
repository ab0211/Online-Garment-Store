			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/ssj5.1.jpg">
								<div class="thumb-image"> <img src="images/ssj5.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj5.2.jpg">
								<div class="thumb-image"> <img src="images/ssj5.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj5.3.jpg">
							<div class="thumb-image"> <img src="images/ssj5.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>My Little Lambs Pink Printed Dungarees</h3>
						<span>Rs 479</span>
						<div class="clearfix"></div>
						<p>This pair of dungarees from My Little Lambs is a must-have in your little one's wardrobe. It can be teamed with a tee and a pair of shoes for a cute look.</p>
		...
		<div class="container">
			<header>
				<h3 class="like text-center">Related Products</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="ssj6.php"><img src="images/ssj6.1.jpg" alt="" /></a>
						<div class="mask">
							<a href="ssj6.php">Quick View</a>	
						</div

			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/ssj2.1.jpg">
								<div class="thumb-image"> <img src="images/ssj2.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj2.2.jpg">
								<div class="thumb-image"> <img src="images/ssj2.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj2.3.jpg">
							<div class="thumb-image"> <img src="images/ssj2.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Mothercare Girls Pink Printed Jumpsuit</h3>
						<span>Rs 479</span>
						<div class="clearfix"></div>
						<p>This playsuit from mothercare will keep your little one comfortable. Let your girl team it up with a pair of canvas shoes for the perfect look.</p>
			...
			<header>
				<h3 class="like text-center">Related Products</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="ssj4.php"><img src="images/ssj4.1.jpg" alt="" /></a>
						<div class="mask">
							<a href="ssj4.php">Quick View</a>
						</div>

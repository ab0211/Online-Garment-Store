			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/ssj4.1.jpg">
								<div class="thumb-image"> <img src="images/ssj4.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj4.2.jpg">
								<div class="thumb-image"> <img src="images/ssj4.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj4.3.jpg">
							<div class="thumb-image"> <img src="images/ssj4.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Beebay Girls Orange & Red Printed Jumpsuit</h3>
						<span>Rs 549</span>
						<div class="clearfix"></div>
						<p>Your little princess is sure to love this stylish jumpsuit from Beebay. Pretty and eye-catching, it can be teamed with a cute pair of ballerinas for an adorable look. </p>

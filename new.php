...
?>
<td><?=$qty * $row[4]?><form method="post"><input type="submit" value="Remove" name="remove"/></form></td>
<?php
...
Total Amount:<input type="text" value="<?=$a[$i]?>" "name="a1" readonly/><input type="submit" value="Checkout" name="checkout"/>
</form>
</div>
<div id="details">

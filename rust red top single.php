			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="myimages/RARE-Rust-Red-Top rear view.jpg">
								<div class="thumb-image"> <img src="myimages/RARE-Rust-Red-Top rear view.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="myimages/RARE-Rust-RedTop backview.jpg">
								<div class="thumb-image"> <img src="myimages/RARE-Rust-RedTop backview.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="myimages/RARE-Rust-Red-Top.jpg">
							<div class="thumb-image"> <img src="myimages/RARE-Rust-Red-Top.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>RARE-Rust-Red-Top </h3>
						<span>Rs.259.00</span>
						<div class="clearfix"></div>
						<p>Perfect for your first day at college, this top lets you flaunt your elegance. Work it with a pair of denims and ballerinas to look simple yet stylish.h</p>
						<p><h5>Product Details</h5>
                           Rust red woven printed blouson top, off-shoulder with shoulder straps, puffed three-quarter sleeves, elasticated hem</p>
                        <p><h5>Material & Care</h5>
						Georgette
						Hand-was</p>
					</div>

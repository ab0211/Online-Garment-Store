			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/ssj6.1.jpg">
								<div class="thumb-image"> <img src="images/ssj6.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj6.2.jpg">
								<div class="thumb-image"> <img src="images/ssj6.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj6.3.jpg">
							<div class="thumb-image"> <img src="images/ssj6.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Naughty Ninos Girls Red & White Dot Printed Dungarees</h3>
						<span>Rs 649</span>
						<div class="clearfix"></div>
						<p>These dungarees are the perfect pick for your little one. We suggest you let her team them with a pair of matching shoes for an adorable look.</p>
		...
		<div class="container">
			<header>
				<h3 class="like text-center">Related Products</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="ssj3.php"><img src="images/ssj3.1.jpg" alt="" /></a>
						<div class="mask">
							<a href="ssj3.php">Quick View</a>	
						</div>

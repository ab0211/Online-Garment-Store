			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/ssj3.1.jpg">
								<div class="thumb-image"> <img src="images/ssj3.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj3.2.jpg">
								<div class="thumb-image"> <img src="images/ssj3.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/ssj3.3.jpg">
							<div class="thumb-image"> <img src="images/ssj3.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>YK Girls Off-White & Navy Printed Shorts</h3>
						<span>Rs 639</span>
						<div class="clearfix"></div>
						<p>This pair of shorts is trendy and crafted with soft and good quality fabric that will keep your little girl comfy and cosy. Let her wear this piece with a solid top and ballerinas for a cute summer look.</p>
			...
			<header>
				<h3 class="like text-center">Related Products</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="ssj2.php"><img src="images/ssj2.1.jpg" alt="" /></a>
						<div class="mask">
							<a href="ssj2.php">Quick View</a>
						</div>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="ssj1.php"><img src="images/ssj1.1.jpg" alt="" /></a>
						<div class="mask">
							<a href="ssj1.php">Quick View</a>	
						</div>
						<!-- <a class="product_name" href="ts4.html">WRONG</a> -->
						<!-- <p><a class="item_add" href="#"><i></i> <span class="item_price">Rs 1299	</span></a></p> -->
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="ssj5.php"><img src="images/ssj5.1.jpg" alt="" /></a>
						<div class="mask">
							<a href="ssj5.php">Quick View</a>	
						</div
